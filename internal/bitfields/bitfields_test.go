...
func TestHasPiece(t *testing.T) {
	bf := Bitfield{0b11010101, 0b01010100}
	outputs := []bool{true, true, false, true, false, true, false, true, false, true, false, true, false, true, false, false, false, false, false, false}
